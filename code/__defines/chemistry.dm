...
#define RC_PROPERTY_HALLUCINATE "randchem_hallucinate"

#define RC_PROPERTY_BERSERK "randchem_berserker"
#define RC_PROPERTY_PACIFIED "randchem_pacifier"
#define RC_PROPERTY_UNDEXTROUS "randchem_paralytic"
#define RC_PROPERTY_HAUNTED "randchem_ghosts"
...
#define RC_PROPERTIES_BENEFICIAL = list(RC_PROPERTY_ANTIEMETIC, RC_PROPERTY_NOITCH, RC_PROPERTY_NOFEVER, RC_PROPERTY_STABLE, RC_PROPERTY_CLEARSIGHT, \
	RC_PROPERTY_STRAIGHTWALK, RC_PROPERTY_NOSTUTTER, RC_PROPERTY_ANTIPARASITIC, RC_PROPERTY_ANTIBIOTIC, RC_PROPERTY_PAINKILLER_WEAK, RC_PROPERTY_PAINKILLER_MILD, \
	...
	RC_PROPERTY_BLOODRESTORER_WEAK, RC_PROPERTY_BLOODRESTORER_MILD, RC_PROPERTY_BLOODRESTORER_STRONG, RC_PROPERTY_BRAINREGENNER_WEAK, \
	RC_PROPERTY_BRAINREGENNER_MILD, RC_PROPERTY_BRAINREGENNER_STRONG)

#define RC_PROPERTIES_TOXIC = list(RC_PROPERTY_NEPHROTOXIN_WEAK, RC_PROPERTY_NEPHROTOXIN_MILD, RC_PROPERTY_NEPHROTOXIN_STRONG, \
	...
	RC_PROPERTY_UNDEXTROUS, RC_PROPERTY_HALLUCINATE, RC_PROPERTY_BERSERK, RC_PROPERTY_PACIFIED, RC_PROPERTY_HAUNTED)

#define RC_PROPERTIES_SIDEEFFECT = list(RC_PROPERTY_EMETIC, RC_PROPERTY_ITCH, RC_PROPERTY_FEVER, RC_PROPERTY_CLUMSY, \
	RC_PROPERTY_DROPITEM)
