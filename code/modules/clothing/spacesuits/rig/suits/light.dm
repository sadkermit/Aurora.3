...
/obj/item/rig/light
	...
	emp_protection = 100
	slowdown = -1
	species_restricted = list(BODYTYPE_HUMAN, BODYTYPE_UNATHI, BODYTYPE_VAURCA)
...
/obj/item/rig/light/falcata
	...
	species_restricted = list(BODYTYPE_HUMAN, BODYTYPE_UNATHI, BODYTYPE_VAURCA, BODYTYPE_IPC)
